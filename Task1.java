...
public class Task1 {
    ...
    public static int playGame(Scanner sc) {
        ...
        int min = 1;
        int max = 100;
        int randomNumber = random.nextInt((max - min) + 1) + min;//for numbers between 1 to 100
        ...
        while (guessedNumber != randomNumber && attempt < maxAttempts) {
            System.out.println("Attempt " + (attempt + 1) + " of " + maxAttempts
